...
export default function ShoppingListItem({ item }: { item: ShoppingItem }) {
  return (
    <div className="flex items-center gap-2.5 px-3.5 py-2.5 border-b border-gray-200 last:border-none hover:bg-gray-100 transition-colors">
      <button
        className={clsx(
          "mt-0.5 w-4.5 h-4.5 rounded-full border-[1.5px] flex items-center justify-center shrink-0",
          item.checked
      ...
      {item.source === "manual" && (
        <button className="text-red-400 shrink-0 w-3 h-3">
